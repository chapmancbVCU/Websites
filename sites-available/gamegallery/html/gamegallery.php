<?php
/******************************************************************************
 *          Name: gamegallery.php
 *        AUTHOR: Chad Chapman
 *  DATE CREATED: 20200810
 *   DESCRIPTION: Template file for top most level web page for the Videl Game
 *                Gallery Website.
 *       VERSION: 1.0
 *****************************************************************************/
?>
    ...
    <body>
        ...
        <div class="content_background">
            ...
            <div id="main">
                ...
                <h2>About</h2>
                <div class=p_div">
                <P class="p_left">This website is about my favorite video games I have owned 
                    ...
                    <p class="p_left">The user can also edit existing entries at a later time 
                        to correct any errors or make updates.
                    </p>
                    <p class="p_left">Finally, we want to add the ability to view images of 
            ...
            <footer>
                <div>
                    ...
                    <p>Date Created: August 10, 2022</p>
